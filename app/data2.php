...
<?php
     ...
     $STDOUT = fopen('json_array.txt', 'wb');
     $STDERR = fopen('error_log.txt', 'wb');
    ...
    $current_histogram_person = $_GET["name"];

    //$current_histogram_person = "Leonardo DiCaprio";

    //echo $current_histogram_person. "<br />";

    $sql = 
    	"SELECT `title`,`vote_average`, `release_date`, `genre_1`, `genre_2`, `genre_3`, `genre_4`, `genre_5`, `popularity`
	FROM `movies`, `worked_on_`
	WHERE `person_name` like '%$current_histogram_person%'
    ...
    /*if ($result->num_rows > 0) {
	    ...
	    while ($row = $result->fetch_assoc()) {
	    	if ($row["vote_average"] != NULL) {
	       		echo $row["title"]. ", " . $row["vote_average"] . "<br>";
	        }
	    } 
    }*/
    ...
    echo "<br />";
    $link = "<a href='./~databaes411/simple_graph.html?name=$current_histogram_person'> Graph ratings! </a><br />";
    echo $link;
    $link = "<a href='./~databaes411/simple_graph_popularity.html?name=$current_histogram_person'> Graph popularity! </a><br />";
    echo $link;
    /*$link = "<a href='./~databaes411/simple_graph_count.html?name=$current_histogram_person'> Graph popularity vs vote count! </a><br />";
    echo $link;*/
