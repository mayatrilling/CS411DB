...
<?php
	$con = mysqli_connect("localhost", "databaes_chaya2", "L1290p", "databaes_imdb");
	
	if (!$con) {
		die("Connection error: " . mysqli_connect_error());
	}
	$movietitle = $_POST["searchtitle"];
	$sql = "INSERT INTO suggested_movies (movie_title) VALUES ('$movietitle')";
	
	if ($con->query($sql) == TRUE) {
		echo "You added the movie " . $movietitle . " to our suggestions queue";
	} else {
