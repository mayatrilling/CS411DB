...
/*
Generate a list of titles that are links to another php page, very similar to this, which will contain the buttons and person info.
*/
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
    	if ($row["name"] != NULL) {
    		$title = $row["name"];
		$link = "<a href='./search_result_person.php?name=$title'> $title </a><br />";
		echo $link;
