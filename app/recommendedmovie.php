...
$sql = "SELECT *
	...
	AND `person_name` = ANY(SELECT `person_name` FROM `worked_on_` WHERE `movie_name` = '$name')
	AND ((`genre_1` = (SELECT `genre_1` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_1` = (SELECT `genre_2` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_1` = (SELECT `genre_3` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_1` = (SELECT `genre_4` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_1` = (SELECT `genre_5` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_2` = (SELECT `genre_1` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_2` = (SELECT `genre_2` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_2` = (SELECT `genre_3` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_2` = (SELECT `genre_4` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_2` = (SELECT `genre_5` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_3` = (SELECT `genre_1` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_3` = (SELECT `genre_2` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_3` = (SELECT `genre_3` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_3` = (SELECT `genre_4` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_3` = (SELECT `genre_5` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_4` = (SELECT `genre_1` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_4` = (SELECT `genre_2` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_4` = (SELECT `genre_3` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_4` = (SELECT `genre_4` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_4` = (SELECT `genre_5` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_5` = (SELECT `genre_1` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_5` = (SELECT `genre_2` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_5` = (SELECT `genre_3` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_5` = (SELECT `genre_4` FROM `movies` WHERE `title` like '%$name%'))
		 OR (`genre_5` = (SELECT `genre_5` FROM `movies` WHERE `title` like '%$name%')))";
